...
export interface IHeaderlessLayout
  extends React.ComponentPropsWithoutRef<'div'> {
  title?: string;
  description?: string;
}

const HeaderlessLayout: React.FC<IHeaderlessLayout> = ({
  children,
  title,
